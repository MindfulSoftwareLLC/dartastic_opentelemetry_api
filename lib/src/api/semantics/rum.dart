...
/// Vendor/RUM (Real User Monitoring) conventions that are NOT part of the
/// OpenTelemetry semantic-conventions registry.
///
/// Everything in this file is deprecated and will be removed from
/// `dartastic_opentelemetry_api`; the future home for these conventions is
/// the Flutter RUM layer, `flutterrific_opentelemetry`.
library;
...
@Deprecated(
    'Vendor/RUM convention, not part of the OTel semantic conventions; will be removed from dartastic_opentelemetry_api')
