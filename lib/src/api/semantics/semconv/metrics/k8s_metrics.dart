...
enum K8sMetric implements OTelMetric {
  ...
  ///
  /// Stability: development
  k8sNodeFilesystemInodeCount('k8s.node.filesystem.inode.count',
      SemanticInstrument.upDownCounter, '{inode}'),

  /// The free inodes in the node's root filesystem.
  ///
  /// Stability: development
  k8sNodeFilesystemInodeFree('k8s.node.filesystem.inode.free',
      SemanticInstrument.upDownCounter, '{inode}'),
  ...
  /// Stability: release_candidate
  k8sNodeMemoryUsage(
      'k8s.node.memory.usage', SemanticInstrument.upDownCounter, 'By'),
  ...
  /// Stability: release_candidate
  k8sPodMemoryUsage(
      'k8s.pod.memory.usage', SemanticInstrument.upDownCounter, 'By'),
