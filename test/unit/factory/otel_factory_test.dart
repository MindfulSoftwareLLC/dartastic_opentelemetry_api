...
void main() {
  group('OTelFactory', () {
    ...
    test('getTracerProviders returns list with both default and named providers', () {
      final factory = OTelFactory.otelFactory!;
    ...
    test('provider lists reflect dynamic changes', () {
      ...
      expect(factory.getTracerProviders(), containsAll([tracerProvider1, tracerProvider2]));
