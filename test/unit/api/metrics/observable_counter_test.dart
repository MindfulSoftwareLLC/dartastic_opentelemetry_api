...
void main() {
  group('APIObservableCounter', () {
    ...
    test('observable counter allows callback to be registered later', () {
      // Arrange
      final counter =
          meter.createObservableCounter<int>(name: 'late-callback-counter');
    ...
    test('observable counter allows callback to be registered and unregistered',
      ...
      // Arrange
      final counter =
          meter.createObservableCounter<int>(name: 'callback-counter');
    ...
    test('generic type constraint is respected', () {
      // Arrange
      final intCounter =
          meter.createObservableCounter<int>(name: 'int-observable-counter');
      final doubleCounter = meter.createObservableCounter<double>(
